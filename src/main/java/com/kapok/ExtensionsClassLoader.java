...
public class ExtensionsClassLoader extends URLClassLoader {
  ...
  public ExtensionsClassLoader(URL[] urls, ClassLoader defaultClassLoader) {
    ...
    System.out.println(String.format("Created ExtensionsClassLoader with jars=%s", urls));
  }
  ...
  public Enumeration<URL> getResources(String name) throws IOException {
    ...
    if (!resources.hasMoreElements()) {
      System.out.println(String.format("Falling back to default class loader for loading resource %s", name));
